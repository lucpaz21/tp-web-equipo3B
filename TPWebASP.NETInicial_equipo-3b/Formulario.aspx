    ...
    <div class="form-container">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="dniText" AutoPostBack="true" runat="server" ClientIDMode="Static" placeholder="Ingrese su DNI" 
                CssClass="form-control" onkeyup="validarNumeros();" OnTextChanged="dniText_TextChanged" />
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="email" runat="server" ClientIDMode="Static" placeholder="Ingrese su email" CssClass="form-control" />
        ...
        <asp:Button ID="btnEnviar" runat="server" ClientIDMode="Static" Text="Participar"  OnClientClick="return validarFormulario()"
